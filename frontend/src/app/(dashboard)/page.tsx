...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    fetch(`${process.env.NEXT_PUBLIC_API_URL}/dashboard/orders-chart`)
      .then((res) => {
        console.log("ORDERS CHART STATUS:", res.status);
        return res.json();
      })
      .then((data) => {
    ...
    fetch(`${process.env.NEXT_PUBLIC_API_URL}/dashboard/category-sales`)
      .then((res) => {
        console.log("CATEGORY SALES STATUS:", res.status);
        return res.json();
      })
      .then((data) => {
    ...
    fetch(`${process.env.NEXT_PUBLIC_API_URL}/dashboard/recent-orders`)
      .then((res) => {
        console.log("RECENT ORDERS STATUS:", res.status);
        return res.json();
      })
      .then((data) => {
    ...
    fetch(`${process.env.NEXT_PUBLIC_API_URL}/dashboard/low-stock`)
      .then((res) => {
        console.log("LOW STOCK STATUS:", res.status);
        return res.json();
      })
      .then((data) => {

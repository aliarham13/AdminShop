...
//         <p className="text-sm text-slate-500">Overview of Sales.</p>
//       </div>

//       <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
//         <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm">
//           <p className="text-xs text-slate-400 font-medium">Total Sales</p>
//           <h3 className="text-xl font-bold text-slate-800 mt-1">${stats?.total_sales ?? "0.00"}</h3>
...
//           <h3 className="text-xl font-bold text-slate-800 mt-1">{stats?.total_orders ?? 0}</h3>
//           <p className="text-xs text-indigo-500 mt-1 font-semibold">In Pipeline</p>
//         </div>

//         <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm">
//           <p className="text-xs text-slate-400 font-medium">Total Products</p>
//           <h3 className="text-xl font-bold text-slate-800 mt-1">{stats?.total_products ?? 0}</h3>
//           <p className="text-xs text-blue-500 mt-1 font-semibold">Live Inventory</p>
//         </div>
...
//           <p className="text-xs text-amber-500 mt-1 font-semibold">Registered</p>
//         </div>

//         <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm">
//           <p className="text-xs text-slate-400 font-medium">Low Stock Items</p>
//           <h3 className="text-xl font-bold text-rose-500 mt-1">{stats?.low_stock_items ?? 0}</h3>
//           <p className="text-xs text-rose-500 mt-1 font-semibold">Requires Restock</p>
//         </div>
//       </div>
...
//             <thead>
//               <tr className="border-b text-slate-500 border-slate-400">
...
//                   <tr key={order.id}>
//                     <td className="py-4.5 font-semibold text-slate-700">{order.id}</td>
//                     <td className="py-4.5 text-slate-600">{order.name}</td>
//                     <td className="py-4.5 text-slate-400">{order.date}</td>
//                     <td className="py-4.5 font-medium text-slate-800">{order.amount}</td>
//                     <td className="py-4.5">
...
//           <div>
//             <p className="text-[11px] text-slate-400">Average Order Value</p>
//             <p className="text-lg font-bold text-slate-800 mt-0.5">${stats?.avg_order_value ?? "0.00"}</p>
//           </div>
//           <span className="text-xs text-emerald-500 font-medium">Live DB</span>
//         </div>
...
//               {stats?.total_customers > 0 ? `${Math.round((stats.total_orders / stats.total_customers) * 100)}%` : "0%"}
//             </p>
//           </div>
//           <span className="text-xs text-emerald-500 font-medium">Live DB</span>
//         </div>
...
//         <div className="bg-white p-4 rounded-xl border border-slate-100 shadow-sm flex items-center justify-between">
//           <div>
//             <p className="text-[11px] text-slate-400">Pipeline Fulfillment</p>
//             <p className="text-lg font-bold text-slate-800 mt-0.5">
//               {totalOrdersCount > 0
//                 ? `${Math.round(((orderChartData.find((x) => x.name === "Completed")?.value || 0) / totalOrdersCount) * 100)}%`
//                 : "0%"}
//             </p>
//           </div>
//           <span className="text-xs text-indigo-500 font-medium">Completed</span>
//         </div>

//         <div className="bg-white p-4 rounded-xl border border-slate-100 shadow-sm flex items-center justify-between">
//           <div>
//             <p className="text-[11px] text-slate-400">Active SKUs</p>
//             <p className="text-lg font-bold text-slate-800 mt-0.5">{stats?.total_products ?? 0}</p>
//           </div>
//           <span className="text-xs text-emerald-500 font-medium">Catalog</span>
//         </div>

//         <div className="bg-white p-4 rounded-xl border border-slate-100 shadow-sm flex items-center justify-between">
//           <div>
//             <p className="text-[11px] text-slate-400">Customer Base</p>
//             <p className="text-lg font-bold text-slate-800 mt-0.5">{stats?.total_customers ?? 0}</p>
//           </div>
//           <span className="text-xs text-emerald-500 font-medium">Total</span>
//         </div>
//       </div>
//     </div>
//   );
...
//             <div
//               key={card.title}
//               className="bg-white rounded-2xl border border-slate-100 p-4 shadow-xs flex items-center justify-between relative overflow-hidden transition-all hover:shadow-md"
//             >
//               <div className="flex items-center gap-3 z-10">
//                 <div
//                   className={`w-10 h-10 rounded-full ${card.iconBg} text-white flex items-center justify-center shrink-0 shadow-xs`}
//                 >
//                   <Icon className="w-5 h-5" strokeWidth={2.2} />
//                 </div>

//                 <div>
//                   <p className="text-xs font-medium text-slate-500 whitespace-nowrap">{card.title}</p>
...
//               <div className="absolute right-2 bottom-1 w-16 h-9 pointer-events-none opacity-85">
//                 <svg className="w-full h-full overflow-visible" viewBox="0 0 80 40" fill="none">
//                   <defs>
//                     <linearGradient id={card.gradId} x1="0" y1="0" x2="0" y2="1">
//                       <stop offset="0%" stopColor={card.stroke} stopOpacity="0.25" />
//                       <stop offset="100%" stopColor={card.stroke} stopOpacity="0" />
//                     </linearGradient>
//                   </defs>
//                   <path
//                     d="M0 28 C 20 32, 30 14, 50 22 C 65 28, 72 8, 80 4 L 80 40 L 0 40 Z"
//                     fill={`url(#${card.gradId})`}
//                   />
//                   <path
//                     d="M0 28 C 20 32, 30 14, 50 22 C 65 28, 72 8, 80 4"
//                     stroke={card.stroke}
//                     strokeWidth="2"
//                     strokeLinecap="round"
//                   />
